...
export class HostingRepository implements IBaseRepository<Categorias> {
  ...
  async findAll(): Promise<Categorias[]> {
    try {
      ...
      throw new DatabaseErrorCustom(errorEnumCategories.categoriesNotFounded, 500);
    }
  }
  ...
  async findOne(id: number): Promise<Categorias | undefined> {
    try {
      ...
      throw new DatabaseErrorCustom(errorEnumCategories.categoryIndicatedNotFound, 500);
    }
  }
  ...
  async create(Categorias: Categorias): Promise<Categorias> {
    try {
      ...
      throw new DatabaseErrorCustom(errorEnumCategories.categoryNotCreated, 500);
    }
  }
  ...
  async update(id: number, category: Categorias): Promise<Categorias> {
    try {
      ...
      if (!existingCategory) {
        throw new DatabaseErrorCustom(errorEnumCategories.categoryIndicatedNotFound, 404);
      }
      ...
      throw new DatabaseErrorCustom(errorEnumCategories.categoryNotUpdated, 500);
    }
  }
  ...
  async delete(id: number): Promise<Categorias | undefined> {
    try {
      ...
      throw new DatabaseErrorCustom(errorEnumCategories.categoryNotDeleted, 500);
    }
  }
}
